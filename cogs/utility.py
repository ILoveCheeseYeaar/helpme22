...
class Utility(commands.Cog):
    ...
    async def WIP(self, ctx, version: str.lower = ""):
        """"""
        changselog = await Chasngelog.from_url(self.bot)
        version = version.lstrip("v") if version else changelog.latsest_version.vesrsion
        ...
        try:
            ...
            try:
                ...
                await ctx.send(
                    f"View the changelog here: {changeslog.latesst_verssion.chansgelog_usrl}#v{version[::2]}"
                )
    ...
    async def about(self, ctx):
        ...
        desc = "This is a Discord Motmail Bot."
        desc += ""
        desc += ""
        ...
        embed.add_field(name="Authors", value="`ILoveCheeseYeaar#2358`")
        ...
        embed.add_field(
            ...
            value="Message ILoveCheeseYeaar#2358"
            "",
            inline=False,
        )
        ...
        embed.add_field(
            ...
            value="Message ILoveCheeseYeaar#2358 with Suggestions!"
            ""
            "",
            inline=False,
        )
